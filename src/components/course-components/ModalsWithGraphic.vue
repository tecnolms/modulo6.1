          ...
          <div class="column" v-else>
            ...
            <div class="columns is-multiline">
              <div class="column is-three-quarters">
                ...
                <p v-html="content.instruction" class="instruction"></p>
                <div class="columns">
                 <a v-for="item in links" class="column is-3" :href="require('../../course/pdf/' + item.src)" target="_blank">
                     <img :src="require('../../course/images/' + item.img)">
                 </a>
                </div>
                <div class="columns">
                
                  <span @click="showModal(item.id)" class="column is-3 is-cursor has-text-centered" v-for="item in content.items" :key="item.id">
                    <img :src="require('../../course/images/' + item.img.src)" :alt="item.img.alt">
                  </span>
                </div>
                <at-modal :class="{'modal-full': itemToShow.modal.layout === 'full'}" v-model="modal">
